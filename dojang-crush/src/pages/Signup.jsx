...
const MakeGroup = styled.button`
  ...
  cursor: pointer;
  &:hover {
    background-color: ${(props) => (props.isGroupMember ? "#c38776" : "none")};
  }
`;
...
const StartGroupMember = styled.button`
  ...
  cursor: pointer;
  &:hover {
    background-color: ${(props) => (props.isGroupMember ? "none" : "#c38776")};
  }
`;
// 입력
        ...
        {isGroupMember ? (
          <EnterInformation>
            ...
            <PWinput
              ...
              type="password"
            />
            <PWCheckinput placeholder="&nbsp; 비밀번호 확인" type="password" />
